package com.example.galleria.common.http;
...
public class NetworkUtility {
    ...
    public static RequestBody createRequestBody(JsonObject jsonObject) {
        ...
        requestTemplate.add("data", jsonObject);
        return RequestBody.create(MediaType.get("application/json"), requestTemplate.toString());
    }
}
