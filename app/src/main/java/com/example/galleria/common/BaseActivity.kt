package com.example.galleria.common
...
import com.example.galleria.databinding.ActivityBaseBinding
...
open class BaseActivity<B, VM> : AppCompatActivity() where B : ViewDataBinding, VM : ViewModel {
    ...
    fun <T> getExtraObject(): T =
        intent.getSerializableExtra(AppConstants.DATA_KEY) as T
